package com.demo.lcboapp.ui.product.search.presenter;
...
import com.demo.lcboapp.ui.product.search.view.ProductsSearchView;
...
public class ProductsSearchPresenter extends BaseMvpPresenter<ProductsSearchView> {

	private Disposable mDisbosable;
	private LCBOApiService mApiService;
	private DatabaseHelper mDatabaseHelper;

	public ProductsSearchPresenter() {
	...
	public void searchProducts(int page, String where, String query) {
		checkViewAttached();
		Utils.unsubscribe(mDisbosable);
